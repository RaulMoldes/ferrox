...
use ferrox::{
    nn::{
        Linear, MSELoss, Loss, Adam, Optimizer, Module
    },
    graph::Engine,
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Parameters initialized: {}", model.parameters_initialized());
    ...
    for epoch in 0..epochs {
        ...
        if epoch % 10 == 0 || epoch == epochs - 1 {
            ...
            println!("   Epoch {}: Loss = {:.6}, f(0) = {:.6}", epoch + 1, loss_value, pred_at_zero);
        }
    }
