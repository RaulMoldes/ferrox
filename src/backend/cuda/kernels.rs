...
const KERNEL_CONFIGS: &[KernelConfig] = &[
    ...
    KernelConfig { 
        ...
        functions: &["sum_axis", "max_along_dim", "sum_axis_f64", "max_along_dim_f64"] 
    },
    KernelConfig { 
        name: "transpose", 
        ptx: TRANSPOSE_PTX, 
    ...
    KernelConfig { 
        ...
        functions: &[
            "greater_equal", "greater_equal_f64", "less_equal", "less_equal_f64", 
...
impl CudaKernels {
    ...
    fn launch_binary_elementwise<T>(&self, kernel_base: &str, cfg: LaunchConfig, 
    ...
    fn launch_unary_elementwise<T>(&self, kernel_base: &str, cfg: LaunchConfig, 
    ...
    fn launch_reduction<T>(&self, kernel_base: &str, cfg: LaunchConfig, 
                          input: &CudaSlice<T>, output: &mut CudaSlice<T>,
    ...
    fn launch_binary_comparison<T>(&self, kernel_base: &str, cfg: LaunchConfig, 
                                  a: &CudaSlice<T>, b: &CudaSlice<T>, 
                                  result: &mut CudaSlice<T>, size: i32) -> Result<(), String>
    where 
        T: crate::backend::number::GPUNumber + 'static,
    ...
    fn launch_unary_comparison<T>(&self, kernel_base: &str, cfg: LaunchConfig, 
